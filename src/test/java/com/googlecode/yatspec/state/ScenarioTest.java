...
class ScenarioTest {
    ...
    private final Scenario scenario = new Scenario("name", new TestText("value"));
    ...
    void uidIsDeterministic() {
        Scenario scenario1 = new Scenario("name", new TestText("value"));
        Scenario scenario2 = new Scenario("name", new TestText("value"));
